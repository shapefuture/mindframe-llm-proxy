...
export const hcDrillsData: HCDrillQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'd', text: 'Both a and b might be underlying assumptions.' },
    ],
    correctAnswerId: 'd', // Updated to reflect that both can be assumptions
  ...
  },
  {
    ...
    questionText: 'When a company decides to build a new factory, which of these is NOT typically considered a primary stakeholder whose perspective is crucial for the company to evaluate?',
    options: [
      ...
      { id: 'd', text: 'A rival company in a different country planning a similar factory.' },
    ],
    correctAnswerId: 'd',
    explanationOnCorrect: 'Correct! While a rival company might be affected indirectly or be a competitor, they are not typically considered a direct stakeholder whose perspective is actively sought and weighed in *this* company\'s internal decision-making process for building *its* factory.',
    explanationOnIncorrect: 'A stakeholder is anyone significantly impacted by a decision or who has a vested interest. Think about who would be directly affected.',
    rewardWXP: 15,
  },
];

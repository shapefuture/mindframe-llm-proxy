...
export const commonOfflineInsightsData: OfflineInsight[] = [
  ...
  },
  {
    ...
    explanation: "Did you know? Confirmation bias makes us seek out info that supports what we already believe. Stay vigilant! Confirmation bias is the tendency to search for, interpret, favor, and recall information in a way that confirms or supports one's preexisting beliefs or hypotheses.",

...
const OnboardingView: React.FC = () => {
  ...
  try {
    ...
    const handleNext = async () => {
      if (currentStep === TOTAL_STEPS - 1) { // After GoalSelect, process and show Cognitive Mirror
        setIsLoading(true);
        try {
          ...
          console.log('[OnboardingView] Processing onboarding data:', onboardingPayload);
        ...
        case TOTAL_STEPS: // Cognitive Mirror Step
          return (
            <CognitiveMirrorStep
              ...
              isLoading={isLoading && !generatedProfile}
            />
          );
        default:
